...
objj_executeFile("views/document_resize_view.j",YES);
...
p;62;app/controllers/properties/property_highlight_t_e_controller.jt;7576;@STATIC;1.0;t;7557;
...
class_addIvars(_2,[new objj_ivar("m_color_well_bgcolor"),new objj_ivar("m_clickable"),new objj_ivar("m_show_as_border"),new objj_ivar("m_rounded_corners"),new objj_ivar("m_link_field"),new objj_ivar("m_rotation_field"),new objj_ivar("m_width_value"),new objj_ivar("m_view_bgcolor"),new objj_ivar("m_view_clickable"),new objj_ivar("m_view_rounded_corners"),new objj_ivar("m_border_width_view"),new objj_ivar("m_rotation_view"),new objj_ivar("m_rounded_corners_example"),new objj_ivar("m_link_value_view"),new objj_ivar("m_rotation_slider"),new objj_ivar("m_slider_border_width")]);
objj_registerClassPair(_2);
class_addMethods(_2,[new objj_method(sel_getUid("awakeFromCib"),function(_4,_5){
with(_4){
objj_msgSendSuper({receiver:_4,super_class:objj_getClass("PropertyHighlightTEController").super_class},"awakeFromCib");
objj_msgSend(CPBox,"makeBorder:",m_view_bgcolor);
objj_msgSend(CPBox,"makeBorder:",m_rotation_view);
...
objj_msgSend(_4,"updateBorderWidthValueTextField");
...
var _6=[objj_msgSend(m_pageElement,"cornerTopLeft"),objj_msgSend(m_pageElement,"cornerTopRight"),objj_msgSend(m_pageElement,"cornerBottomLeft"),objj_msgSend(m_pageElement,"cornerBottomRight")];
objj_msgSend(_4,"setCornerSliders:",_6);
...
objj_msgSend(m_rotation_slider,"setValue:",objj_msgSend(m_pageElement,"rotation"));
objj_msgSend(_4,"setRotationValue:",m_rotation_slider);
}
}),new objj_method(sel_getUid("toggleCorners:"),function(_7,_8,_9){
with(_7){
if(objj_msgSend(m_rounded_corners,"state")==CPOnState){
objj_msgSend(m_view_rounded_corners,"setHidden:",NO);
}else{
objj_msgSend(_7,"setCornerSliders:",[0,0,0,0]);
objj_msgSend(m_view_rounded_corners,"setHidden:",YES);
}
objj_msgSend(_7,"setPageElementCornerValues");
objj_msgSend(m_pageElement,"redisplay");
}
}),new objj_method(sel_getUid("setCornerValue:"),function(_a,_b,_c){
with(_a){
var _d;
if(objj_msgSend(_c,"isKindOfClass:",CPSlider)){
_d=objj_msgSend(_c,"intValue");
objj_msgSend(objj_msgSend(_a,"findViewWithTag:inViews:ofClass:",objj_msgSend(_c,"tag"),objj_msgSend(m_view_rounded_corners,"subviews"),CPTextField),"setStringValue:",(""+objj_msgSend(_c,"intValue")));
}else{
_d=objj_msgSend(objj_msgSend(_c,"stringValue"),"intValue");
objj_msgSend(objj_msgSend(_a,"findViewWithTag:inViews:ofClass:",objj_msgSend(_c,"tag"),objj_msgSend(m_view_rounded_corners,"subviews"),CPSlider),"setValue:",objj_msgSend(objj_msgSend(_c,"stringValue"),"intValue"));
}
objj_msgSend(m_pageElement,"performSelector:withObject:",_1[objj_msgSend(_c,"tag")],_d);
objj_msgSend(m_pageElement,"redisplay");
}
}),new objj_method(sel_getUid("setRotationValue:"),function(_e,_f,_10){
with(_e){
if(objj_msgSend(_10,"isKindOfClass:",CPTextField)){
objj_msgSend(m_rotation_slider,"setValue:",objj_msgSend(objj_msgSend(_10,"stringValue"),"intValue"));
}else{
objj_msgSend(m_rotation_field,"setStringValue:",(""+objj_msgSend(_10,"intValue")));
}
objj_msgSend(m_pageElement,"setRotation:",objj_msgSend(m_rotation_slider,"intValue"));
objj_msgSend(m_pageElement,"redisplay");
}
...
}),new objj_method(sel_getUid("updateBorderWidth:"),function(_14,_15,_16){
with(_14){
objj_msgSend(_14,"updateBorderWidthValueTextField");
objj_msgSend(m_pageElement,"setBorderWidth:",objj_msgSend(m_slider_border_width,"intValue"));
objj_msgSend(m_pageElement,"redisplay");
}
}),new objj_method(sel_getUid("updateIsBorder:"),function(_17,_18,_19){
with(_17){
...
}),new objj_method(sel_getUid("updateClickable:"),function(_1a,_1b,_1c){
with(_1a){
...
}),new objj_method(sel_getUid("accept:"),function(_1d,_1e,_1f){
with(_1d){
objj_msgSend(_window,"close");
objj_msgSend(m_pageElement,"setLinkUrl:",objj_msgSend(m_link_field,"stringValue"));
objj_msgSend(m_pageElement,"updateServer");
}
}),new objj_method(sel_getUid("updateBorderWidthValueTextField"),function(_20,_21){
with(_20){
...
}),new objj_method(sel_getUid("findViewWithTag:inViews:ofClass:"),function(_22,_23,_24,_25,_26){
with(_22){
var cnt=objj_msgSend(_25,"count");
for(var idx=0;idx<cnt;idx++){
if(objj_msgSend(_25[idx],"isKindOfClass:",_26)&&objj_msgSend(_25[idx],"tag")==_24){
return _25[idx];
}
}
return nil;
}
}),new objj_method(sel_getUid("setCornerSliders:"),function(_27,_28,_29){
with(_27){
for(var idx=0;idx<4;idx++){
var _2a=objj_msgSend(_27,"findViewWithTag:inViews:ofClass:",idx,objj_msgSend(m_view_rounded_corners,"subviews"),CPSlider);
objj_msgSend(_2a,"setIntValue:",_29[idx]);
var _2b=objj_msgSend(_27,"findViewWithTag:inViews:ofClass:",idx,objj_msgSend(m_view_rounded_corners,"subviews"),CPTextField);
objj_msgSend(_2b,"setStringValue:",(""+_29[idx]));
}
}
}),new objj_method(sel_getUid("setPageElementCornerValues"),function(_2c,_2d){
with(_2c){
for(var idx=0;idx<4;idx++){
objj_msgSend(m_pageElement,"performSelector:withObject:",_1[idx],objj_msgSend(objj_msgSend(_2c,"findViewWithTag:inViews:ofClass:",idx,objj_msgSend(m_view_rounded_corners,"subviews"),CPSlider),"intValue"));
}
}
})]);
p;58;app/controllers/properties/property_image_t_e_controller.jt;5949;@STATIC;1.0;t;5930;
...
class_addMethods(_1,[new objj_method(sel_getUid("awakeFromCib"),function(_3,_4){
with(_3){
objj_msgSendSuper({receiver:_3,super_class:objj_getClass("PropertyImageTEController").super_class},"awakeFromCib");
...
m_orig_rotation=objj_msgSend(m_pageElement,"rotation");
objj_msgSend(m_rotationSlider,"setValue:",objj_msgSend(m_pageElement,"rotation"));
objj_msgSend(_3,"updateRotationValue");
objj_msgSend(_3,"setFocusOn:",m_widthField);
}
}),new objj_method(sel_getUid("setRotationValue:"),function(_6,_7,_8){
with(_6){
objj_msgSend(m_rotationSlider,"setValue:",objj_msgSend(m_rotationValue,"intValue"));
objj_msgSend(_6,"updateRotationValue");
}
}),new objj_method(sel_getUid("setRotation:"),function(_9,_a,_b){
with(_9){
objj_msgSend(_9,"updateRotationValue");
}
}),new objj_method(sel_getUid("setReloadInterval:"),function(_c,_d,_e){
with(_c){
objj_msgSend(_c,"updateReloadIntervalScroller");
}
}),new objj_method(sel_getUid("reloadButtonPressed:"),function(_f,_10,_11){
with(_f){
if(objj_msgSend(m_reloadButton,"state")==CPOnState){
objj_msgSend(m_intervalScrollView,"setHidden:",NO);
objj_msgSend(_f,"updateReloadIntervalScroller");
}else{
objj_msgSend(m_intervalScrollView,"setHidden:",YES);
...
}),new objj_method(sel_getUid("setSizeToOriginal:"),function(_12,_13,_14){
with(_12){
...
}),new objj_method(sel_getUid("scaleWidth:"),function(_15,_16,_17){
with(_15){
...
}),new objj_method(sel_getUid("scaleHeight:"),function(_18,_19,_1a){
with(_18){
...
}),new objj_method(sel_getUid("cancel:"),function(_1b,_1c,_1d){
with(_1b){
objj_msgSendSuper({receiver:_1b,super_class:objj_getClass("PropertyImageTEController").super_class},"cancel:",_1d);
objj_msgSend(m_pageElement,"setRotation:",m_orig_rotation);
}
}),new objj_method(sel_getUid("accept:"),function(_1e,_1f,_20){
with(_1e){
...
var _21=CGSizeMake(objj_msgSend(m_widthField,"doubleValue"),objj_msgSend(m_heightField,"doubleValue"));
objj_msgSend(m_pageElement,"setFrameSize:",_21);
...
}),new objj_method(sel_getUid("updateReloadIntervalScroller"),function(_22,_23){
with(_22){
...
}),new objj_method(sel_getUid("updateRotationValue"),function(_24,_25){
with(_24){
var _26=objj_msgSend(objj_msgSend(m_rotationSlider,"stringValue"),"intValue");
var str=objj_msgSend(CPString,"stringWithFormat:","%d",_26);
objj_msgSend(m_rotationValue,"setStringValue:",str);
objj_msgSend(m_pageElement,"setRotation:",_26);
}
})]);
p;57;app/controllers/properties/property_link_t_e_controller.jt;2727;@STATIC;1.0;t;2708;
var _1=objj_allocateClassPair(PropertyWindowController,"PropertyLinkTEController"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_colorWell"),new objj_ivar("m_linkDestination"),new objj_ivar("m_linkTitle"),new objj_ivar("m_fontSizeLabel"),new objj_ivar("m_fontSizeSlider"),new objj_ivar("m_fontNameButton")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("awakeFromCib"),function(_3,_4){
with(_3){
objj_msgSendSuper({receiver:_3,super_class:objj_getClass("PropertyLinkTEController").super_class},"awakeFromCib");
objj_msgSend(CPBox,"makeBorder:",m_colorWell);
objj_msgSend(m_fontNameButton,"removeAllItems");
var _5=objj_msgSend(objj_msgSend(CPFontManager,"sharedFontManager"),"availableFonts");
for(var _6=0;_6<objj_msgSend(_5,"count");_6++){
var _7=objj_msgSend(_5,"objectAtIndex:",_6);
var _8=objj_msgSend(objj_msgSend(CPMenuItem,"alloc"),"initWithTitle:action:keyEquivalent:",_7,NULL,nil);
objj_msgSend(_8,"setFont:",objj_msgSend(CPFont,"fontWithName:size:",_7,11));
objj_msgSend(m_fontNameButton,"addItem:",_8);
}
objj_msgSend(m_fontNameButton,"selectItemWithTitle:",objj_msgSend(m_pageElement,"fontName"));
objj_msgSend(m_fontSizeSlider,"setDoubleValue:",objj_msgSend(m_pageElement,"fontSize"));
...
objj_msgSend(_3,"setFocusOn:",m_linkDestination);
}
}),new objj_method(sel_getUid("fontNameSelected:"),function(_9,_a,_b){
with(_9){
objj_msgSend(m_pageElement,"setFontName:",objj_msgSend(objj_msgSend(m_fontNameButton,"selectedItem"),"title"));
}
}),new objj_method(sel_getUid("fontSizeSliderAction:"),function(_c,_d,_e){
with(_c){
objj_msgSend(m_fontSizeLabel,"setStringValue:",objj_msgSend(CPString,"stringWithFormat:","%0.2f",objj_msgSend(m_fontSizeSlider,"doubleValue")));
objj_msgSend(m_pageElement,"setFontSize:",objj_msgSend(m_fontSizeSlider,"doubleValue"));
}
}),new objj_method(sel_getUid("updateColor:"),function(_f,_10,_11){
with(_f){
objj_msgSend(m_pageElement,"setLinkColor:",objj_msgSend(m_colorWell,"color"));
}
}),new objj_method(sel_getUid("accept:"),function(_12,_13,_14){
with(_12){
...
p;63;app/controllers/properties/property_pay_pal_button_controller.jt;1935;@STATIC;1.0;t;1916;
var _1=objj_allocateClassPair(PropertyWindowController,"PropertyPayPalButtonController"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_recipient"),new objj_ivar("m_currency_list"),new objj_ivar("m_size_small"),new objj_ivar("m_size_large"),new objj_ivar("m_size_large_with_cc")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("awakeFromCib"),function(_3,_4){
with(_3){
...
p;57;app/controllers/properties/property_text_t_e_controller.jt;2247;@STATIC;1.0;t;2228;
var _1=objj_allocateClassPair(PropertyWindowController,"PropertyTextTEController"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_fontSizeLabel"),new objj_ivar("m_fontSizeSlider"),new objj_ivar("m_colorWell"),new objj_ivar("m_fontNameButton")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("awakeFromCib"),function(_3,_4){
with(_3){
objj_msgSendSuper({receiver:_3,super_class:objj_getClass("PropertyTextTEController").super_class},"awakeFromCib");
objj_msgSend(m_fontNameButton,"removeAllItems");
objj_msgSend(CPBox,"makeBorder:",m_colorWell);
var _5=objj_msgSend(objj_msgSend(CPFontManager,"sharedFontManager"),"availableFonts");
for(var _6=0;_6<objj_msgSend(_5,"count");_6++){
...
p;55;app/controllers/properties/property_window_controller.jt;1199;@STATIC;1.0;t;1180;
...
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",_7,sel_getUid("windowWillClose:"),CPWindowWillCloseNotification,_window);
}
}),new objj_method(sel_getUid("windowWillClose:"),function(_9,_a,_b){
with(_9){
objj_msgSend(objj_msgSend(CPColorPanel,"sharedColorPanel"),"close");
}
}),new objj_method(sel_getUid("cancel:"),function(_c,_d,_e){
with(_c){
objj_msgSend(m_pageElement,"popState");
objj_msgSend(_window,"close");
}
}),new objj_method(sel_getUid("setFocusOn:"),function(_f,_10,_11){
with(_f){
objj_msgSend(_window,"makeFirstResponder:",_11);
}
})]);
p;74;app/controllers/properties/property_you_tube_seek_to_link_t_e_controller.jt;5614;@STATIC;1.0;t;5595;
var _1=objj_allocateClassPair(PropertyWindowController,"PropertyYouTubeSeekToLinkTEController"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_colorWell"),new objj_ivar("m_linkTitle"),new objj_ivar("m_fontSizeLabel"),new objj_ivar("m_fontNameButton"),new objj_ivar("m_fontSizeSlider"),new objj_ivar("m_fontView"),new objj_ivar("m_videoInfoView"),new objj_ivar("m_endAtView"),new objj_ivar("m_setEndAt"),new objj_ivar("m_videoDropdown")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("awakeFromCib"),function(_3,_4){
with(_3){
objj_msgSendSuper({receiver:_3,super_class:objj_getClass("PropertyYouTubeSeekToLinkTEController").super_class},"awakeFromCib");
objj_msgSend(SeekToDropdownHelpers,"addToClassOfObject:",_3);
objj_msgSend(CPBox,"makeBorder:",m_fontView);
...
var _8=objj_msgSend(CPMenuItem,"withTitle:andTag:","None Set",0);
objj_msgSend(m_videoDropdown,"addItem:",_8);
var _9=objj_msgSend(objj_msgSend(DocumentViewController,"sharedInstance"),"allPageElementsOfType:orType:",YouTubeVideo,YouTubeTE);
for(var _6=0;_6<objj_msgSend(_9,"count");_6++){
var _a=_9[_6];
var _8=objj_msgSend(CPMenuItem,"withTitle:andTag:",objj_msgSend(_a,"videoTitle"),objj_msgSend(_a,"videoId"));
objj_msgSend(m_videoDropdown,"addItem:",_8);
}
objj_msgSend(m_videoDropdown,"selectItemWithTag:",objj_msgSend(objj_msgSend(m_pageElement,"videoId"),"intValue"));
var _b=objj_msgSend(_3,"obtainStartAtPopUps:",objj_msgSend(m_videoInfoView,"subviews"));
objj_msgSend(_3,"setSeekToPopUpValues:",_b);
objj_msgSend(_3,"setPopUpsWithTime:popUps:",objj_msgSend(m_pageElement,"startAt"),_b);
...
var _b=objj_msgSend(_3,"obtainEndAtPopUps:",objj_msgSend(m_endAtView,"subviews"));
objj_msgSend(_3,"setSeekToPopUpValues:",_b);
objj_msgSend(_3,"setPopUpsWithTime:popUps:",objj_msgSend(m_pageElement,"endAt"),_b);
objj_msgSend(_3,"setFocusOn:",m_linkTitle);
}
...
}),new objj_method(sel_getUid("fontNameSelected:"),function(_11,_12,_13){
with(_11){
objj_msgSend(m_pageElement,"setFontName:",objj_msgSend(objj_msgSend(m_fontNameButton,"selectedItem"),"title"));
}
}),new objj_method(sel_getUid("fontSizeSliderAction:"),function(_14,_15,_16){
with(_14){
objj_msgSend(m_fontSizeLabel,"setStringValue:",objj_msgSend(CPString,"stringWithFormat:","%0.2f",objj_msgSend(m_fontSizeSlider,"doubleValue")));
objj_msgSend(m_pageElement,"setFontSize:",objj_msgSend(m_fontSizeSlider,"doubleValue"));
}
}),new objj_method(sel_getUid("updateColor:"),function(_17,_18,_19){
with(_17){
objj_msgSend(m_pageElement,"setTextColor:",objj_msgSend(m_colorWell,"color"));
}
}),new objj_method(sel_getUid("accept:"),function(_1a,_1b,_1c){
...
break;
case CPOnState:
objj_msgSend(m_pageElement,"setEndAt:",objj_msgSend(_1a,"obtainSeconds:",objj_msgSend(_1a,"obtainEndAtPopUps:",objj_msgSend(m_endAtView,"subviews"))));
break;
}
objj_msgSend(m_pageElement,"setStartAt:",objj_msgSend(_1a,"obtainSeconds:",objj_msgSend(_1a,"obtainStartAtPopUps:",objj_msgSend(m_videoInfoView,"subviews"))));
...
}),new objj_method(sel_getUid("obtainStartAtPopUps:"),function(_1d,_1e,_1f){
with(_1d){
return objj_msgSend(_1d,"findPopUpsWithTags:inViews:",[1,2,4],_1f);
}
}),new objj_method(sel_getUid("obtainEndAtPopUps:"),function(_20,_21,_22){
with(_20){
return objj_msgSend(_20,"findPopUpsWithTags:inViews:",[8,16,32],_22);
}
})]);
p;63;app/controllers/properties/property_you_tube_video_controller.jt;5060;@STATIC;1.0;t;5041;
var _1=objj_allocateClassPair(PropertyWindowController,"PropertyYouTubeVideoController"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_artistName"),new objj_ivar("m_artistUrl"),new objj_ivar("m_videoLink"),new objj_ivar("m_rotationValue"),new objj_ivar("m_videoIdField"),new objj_ivar("m_artistView"),new objj_ivar("m_linkAndTitleView"),new objj_ivar("m_searchLinksView"),new objj_ivar("m_playerCtrlView"),new objj_ivar("m_rotationView"),new objj_ivar("m_cueVideoView"),new objj_ivar("m_rotationSlider"),new objj_ivar("m_original_value"),new objj_ivar("m_original_rotation")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("awakeFromCib"),function(_3,_4){
with(_3){
objj_msgSendSuper({receiver:_3,super_class:objj_getClass("PropertyYouTubeVideoController").super_class},"awakeFromCib");
objj_msgSend(SeekToDropdownHelpers,"addToClassOfObject:",_3);
...
objj_msgSend(_3,"checkCheckBoxes:",objj_msgSend(m_searchLinksView,"subviews"));
objj_msgSend(_3,"checkCheckBoxes:",objj_msgSend(m_linkAndTitleView,"subviews"));
objj_msgSend(_3,"checkCheckBoxes:",objj_msgSend(m_playerCtrlView,"subviews"));
...
var _5=objj_msgSend(_3,"findPopUpsWithTags:inViews:",[1,2,4],objj_msgSend(m_cueVideoView,"subviews"));
objj_msgSend(_3,"setSeekToPopUpValues:",_5);
objj_msgSend(_3,"setPopUpsWithTime:popUps:",objj_msgSend(m_pageElement,"seekTo"),_5);
m_original_rotation=objj_msgSend(m_pageElement,"rotation");
objj_msgSend(m_rotationSlider,"setValue:",objj_msgSend(m_pageElement,"rotation"));
objj_msgSend(_3,"updateRotationValue");
var _6=objj_msgSend(CPString,"stringWithFormat:","(ID: %d)",objj_msgSend(m_pageElement,"videoId"));
objj_msgSend(m_videoIdField,"setStringValue:",_6);
objj_msgSend(m_videoIdField,"setHidden:",YES);
}
}),new objj_method(sel_getUid("checkCheckBoxes:"),function(_7,_8,_9){
with(_7){
var _a=objj_msgSend(_9,"count");
for(var _b=0;_b<_a;_b++){
if(objj_msgSend(_9[_b],"isKindOfClass:",CPCheckBox)){
if((m_original_value&[objj_msgSend(_9[_b],"tag")])>0){
objj_msgSend(_9[_b],"setState:",CPOnState);
}else{
objj_msgSend(_9[_b],"setState:",CPOffState);
}
}
}
}
}),new objj_method(sel_getUid("setRotationValue:"),function(_c,_d,_e){
with(_c){
objj_msgSend(m_rotationSlider,"setValue:",objj_msgSend(m_rotationValue,"intValue"));
objj_msgSend(_c,"updateRotationValue");
}
}),new objj_method(sel_getUid("setRotationFromSlider:"),function(_f,_10,_11){
with(_f){
objj_msgSend(_f,"updateRotationValue");
}
}),new objj_method(sel_getUid("searchButton:"),function(_12,_13,_14){
with(_12){
if(objj_msgSend(_14,"state")==CPOffState){
objj_msgSend(m_pageElement,"removeSearchEngine:",objj_msgSend(_14,"tag"));
if(objj_msgSend(_14,"tag")==256){
objj_msgSend(m_cueVideoView,"setHidden:",YES);
}
}else{
objj_msgSend(m_pageElement,"addSearchEngine:",objj_msgSend(_14,"tag"));
if(objj_msgSend(_14,"tag")==256){
objj_msgSend(m_cueVideoView,"setHidden:",NO);
}
}
}
}),new objj_method(sel_getUid("cancel:"),function(_15,_16,_17){
with(_15){
objj_msgSendSuper({receiver:_15,super_class:objj_getClass("PropertyYouTubeVideoController").super_class},"cancel:",_17);
objj_msgSend(m_pageElement,"setSearchEngines:",m_original_value);
objj_msgSend(m_pageElement,"setRotation:",m_original_rotation);
}
}),new objj_method(sel_getUid("accept:"),function(_18,_19,_1a){
with(_18){
if((objj_msgSend(m_pageElement,"searchEngines")&256)>0){
var _1b=objj_msgSend(_18,"findPopUpsWithTags:inViews:",[1,2,4],objj_msgSend(m_cueVideoView,"subviews"));
objj_msgSend(m_pageElement,"setSeekTo:",objj_msgSend(_18,"obtainSeconds:",_1b));
}else{
...
}),new objj_method(sel_getUid("updateRotationValue"),function(_1c,_1d){
with(_1c){
var str=objj_msgSend(CPString,"stringWithFormat:","%d",objj_msgSend(m_rotationSlider,"intValue"));
objj_msgSend(m_pageElement,"setRotation:",objj_msgSend(m_rotationSlider,"intValue"));
objj_msgSend(m_rotationValue,"setStringValue:",str);
}
})]);
...
p;34;app/helpers/image_loader_helpers.jt;3736;@STATIC;1.0;t;3717;
var _1=objj_allocateClassPair(CPObject,"ImageLoaderWorker"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_image"),new objj_ivar("m_imageView"),new objj_ivar("m_delegate"),new objj_ivar("m_selector"),new objj_ivar("m_rotation_value")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("initWithUrl:imageView:tempImage:delegate:selector:rotation:"),function(_3,_4,_5,_6,_7,_8,_9,_a){
with(_3){
...
}),new objj_method(sel_getUid("imageDidLoad:"),function(_b,_c,_d){
with(_b){
objj_msgSend(m_imageView,"setImage:",_d);
...
objj_msgSend(m_delegate,"performSelector:withObject:",m_selector,_d);
}
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("workerFor:imageView:"),function(_e,_f,_10,_11){
with(_e){
return objj_msgSend(objj_msgSend(ImageLoaderWorker,"alloc"),"initWithUrl:imageView:tempImage:delegate:selector:rotation:",_10,_11,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"spinner"),nil,nil,nil);
}
}),new objj_method(sel_getUid("workerFor:imageView:rotation:"),function(_12,_13,_14,_15,_16){
with(_12){
return objj_msgSend(objj_msgSend(ImageLoaderWorker,"alloc"),"initWithUrl:imageView:tempImage:delegate:selector:rotation:",_14,_15,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"spinner"),nil,nil,_16);
}
}),new objj_method(sel_getUid("workerFor:imageView:tempImage:"),function(_17,_18,_19,_1a,_1b){
with(_17){
return objj_msgSend(objj_msgSend(ImageLoaderWorker,"alloc"),"initWithUrl:imageView:tempImage:delegate:selector:rotation:",_19,_1a,_1b,nil,nil,nil);
}
}),new objj_method(sel_getUid("workerFor:imageView:delegate:selector:"),function(_1c,_1d,_1e,_1f,_20,_21){
with(_1c){
return objj_msgSend(objj_msgSend(ImageLoaderWorker,"alloc"),"initWithUrl:imageView:tempImage:delegate:selector:rotation:",_1e,_1f,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"spinner"),_20,_21,nil);
}
})]);
...
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("image"),function(_22,_23){
with(_22){
return image;
}
...
}),new objj_method(sel_getUid("path"),function(_27,_28){
with(_27){
return path;
}
}),new objj_method(sel_getUid("setPath:"),function(_29,_2a,_2b){
with(_29){
path=_2b;
}
}),new objj_method(sel_getUid("initWithPath:"),function(_2c,_2d,_2e){
with(_2c){
_2c=objj_msgSendSuper({receiver:_2c,super_class:objj_getClass("PMGetImageWorker").super_class},"init");
if(_2c){
path=_2e;
image=objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:",path);
objj_msgSend(image,"setDelegate:",_2c);
}
return _2c;
}
}),new objj_method(sel_getUid("imageDidLoad:"),function(_2f,_30,_31){
with(_2f){
image=_31;
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("workerFor:"),function(_32,_33,_34){
with(_32){
return objj_msgSend(objj_msgSend(PMGetImageWorker,"alloc"),"initWithPath:",_34);
}
})]);
p;26;app/helpers/mixin_helper.jt;605;@STATIC;1.0;t;587;
var _1=objj_allocateClassPair(CPObject,"MixinHelper"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;29;app/helpers/p_m_info_window.jt;2943;@STATIC;1.0;t;2924;
var _1=objj_allocateClassPair(CPAlert,"PMInfoWindow"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;30;app/libs/placeholder_manager.jt;13188;@STATIC;1.0;t;13168;
var _1=nil;
...
}),new objj_method(sel_getUid("propertyPageButton"),function(_81,_82){
with(_81){
return objj_msgSend(objj_msgSend(_store,"objectForKey:","properties_32"),"image");
}
}),new objj_method(sel_getUid("copyPageButton"),function(_83,_84){
with(_83){
return objj_msgSend(objj_msgSend(_store,"objectForKey:","copy_page_32"),"image");
}
}),new objj_method(sel_getUid("newPageButton"),function(_85,_86){
with(_85){
return objj_msgSend(objj_msgSend(_store,"objectForKey:","new_page_32"),"image");
}
}),new objj_method(sel_getUid("deletePageButton"),function(_87,_88){
with(_87){
return objj_msgSend(objj_msgSend(_store,"objectForKey:","delete_page_32"),"image");
}
}),new objj_method(sel_getUid("propertyPublicationButton"),function(_89,_8a){
with(_89){
return objj_msgSend(objj_msgSend(_store,"objectForKey:","property_32"),"image");
}
}),new objj_method(sel_getUid("propertyPublicationButtonHigh"),function(_8b,_8c){
with(_8b){
return objj_msgSend(objj_msgSend(_store,"objectForKey:","property_32_high"),"image");
}
})]);
class_addMethods(_4,[new objj_method(sel_getUid("sharedInstance"),function(_8d,_8e){
with(_8d){
if(!_1){
...
}),new objj_method(sel_getUid("imageFor:"),function(_8f,_90,_91){
with(_8f){
return objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"performSelector:",_91);
}
}),new objj_method(sel_getUid("placeholderImageUrl"),function(_92,_93){
with(_92){
return "http://assets.2monki.es/images/placeholder.png";
}
}),new objj_method(sel_getUid("moustacheImageUrl"),function(_94,_95){
with(_94){
return "http://assets.2monki.es/images/moustache.png";
}
})]);
p;24;app/libs/theme_manager.jt;2696;@STATIC;1.0;t;2677;
var _1=nil;
...
p;33;app/mixins/alert_window_support.jt;1825;@STATIC;1.0;t;1806;
var _1=objj_allocateClassPair(MixinHelper,"AlertWindowSupport"),_2=_1.isa;
...
with(_8){
m_aws_alert_window=objj_msgSend(objj_msgSend(PMInfoWindow,"alloc"),"init");
...
p;40;app/mixins/document_view_cell_snapgrid.jt;1854;@STATIC;1.0;t;1835;
var _1=objj_allocateClassPair(MixinHelper,"DocumentViewCellWithoutSnapgrid"),_2=_1.isa;
objj_registerClassPair(_1);
...
var _1=objj_allocateClassPair(MixinHelper,"DocumentViewCellWithSnapgrid"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;37;app/mixins/image_element_properties.jt;2513;@STATIC;1.0;t;2494;
var _1=objj_allocateClassPair(MixinHelper,"ImageElementProperties"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_destUrl"),new objj_ivar("m_reloadInterval"),new objj_ivar("m_rotation")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("linkUrl"),function(_3,_4){
with(_3){
return m_destUrl;
}
}),new objj_method(sel_getUid("reloadInterval"),function(_5,_6){
with(_5){
return m_reloadInterval;
}
}),new objj_method(sel_getUid("setReloadInterval:"),function(_7,_8,_9){
with(_7){
m_reloadInterval=_9;
}
}),new objj_method(sel_getUid("rotation"),function(_a,_b){
with(_a){
return m_rotation;
}
}),new objj_method(sel_getUid("setImagePropertiesFromJson"),function(_c,_d){
with(_c){
...
}),new objj_method(sel_getUid("setDestUrlFromJson:"),function(_e,_f,_10){
with(_e){
m_destUrl=is_defined(_json.dest_url)?_json.dest_url:_10;
}
}),new objj_method(sel_getUid("hasProperties"),function(_11,_12){
with(_11){
return YES;
}
}),new objj_method(sel_getUid("openProperyWindow"),function(_13,_14){
with(_13){
objj_msgSend(objj_msgSend(objj_msgSend(PropertyImageTEController,"alloc"),"initWithWindowCibName:pageElement:",ImageTEPropertyWindowCIB,_13),"showWindow:",_13);
}
}),new objj_method(sel_getUid("setLinkUrl:"),function(_15,_16,_17){
with(_15){
m_destUrl=_17;
}
}),new objj_method(sel_getUid("getImageSize"),function(_18,_19){
with(_18){
return objj_msgSend(objj_msgSend(_mainView,"image"),"size");
}
}),new objj_method(sel_getUid("setRotation:"),function(_1a,_1b,_1c){
with(_1a){
m_rotation=_1c;
if(objj_msgSend(_mainView,"respondsToSelector:",sel_getUid("setRotationDegrees:"))){
...
objj_msgSend(ImageLoaderWorker,"workerFor:imageView:rotation:",url,_mainView,objj_msgSend(_1d,"rotation"));
objj_msgSend(_1f,"addSubview:",_mainView);
}
})]);
p;33;app/mixins/object_state_support.jt;877;@STATIC;1.0;t;859;
var _1=objj_allocateClassPair(MixinHelper,"ObjectStateSupport"),_2=_1.isa;
...
p;39;app/mixins/page_element_color_support.jt;1283;@STATIC;1.0;t;1264;
var _1=objj_allocateClassPair(MixinHelper,"PageElementColorSupport"),_2=_1.isa;
...
p;38;app/mixins/page_element_font_support.jt;1803;@STATIC;1.0;t;1784;
var _1=objj_allocateClassPair(MixinHelper,"PageElementFontSupport"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_fontSize"),new objj_ivar("m_fontName"),new objj_ivar("m_fontObj")]);
objj_registerClassPair(_1);
...
}),new objj_method(sel_getUid("setFontFromJson"),function(_12,_13){
with(_12){
m_fontSize=_json.font_size;
m_fontName=_json.font_name;
objj_msgSend(_12,"_setFont");
}
}),new objj_method(sel_getUid("_setFont"),function(_14,_15){
with(_14){
if(!m_fontSize){
m_fontSize=12;
}
...
}),new objj_method(sel_getUid("setFontSize:"),function(_16,_17,_18){
with(_16){
m_fontSize=_18;
objj_msgSend(_16,"_setFont");
objj_msgSend(_mainView,"setFont:",m_fontObj);
}
}),new objj_method(sel_getUid("setFontName:"),function(_19,_1a,_1b){
with(_19){
m_fontName=_1b;
objj_msgSend(_19,"_setFont");
objj_msgSend(_mainView,"setFont:",m_fontObj);
}
}),new objj_method(sel_getUid("setFont:"),function(_1c,_1d,_1e){
with(_1c){
m_fontSize=objj_msgSend(_1e,"size");
m_fontName=objj_msgSend(_1e,"familyName");
m_fontObj=_1e;
objj_msgSend(_mainView,"setFont:",m_fontObj);
}
})]);
p;39;app/mixins/page_element_input_support.jt;578;@STATIC;1.0;t;560;
var _1=objj_allocateClassPair(MixinHelper,"PageElementInputSupport"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;38;app/mixins/page_element_size_support.jt;876;@STATIC;1.0;t;858;
var _1=objj_allocateClassPair(MixinHelper,"PageElementSizeSupport"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;44;app/mixins/page_element_text_input_support.jt;2141;@STATIC;1.0;t;2122;
var _1=objj_allocateClassPair(MixinHelper,"PageElementTextInputSupport"),_2=_1.isa;
objj_registerClassPair(_1);
...
}),new objj_method(sel_getUid("checkForChangedText:"),function(_6,_7,_8){
with(_6){
if(objj_msgSend(_6,"textTyped")!==_8){
objj_msgSend(_6,"setTextTyped:",_8);
objj_msgSend(_6,"updateServer");
}
}
}),new objj_method(sel_getUid("controlTextDidBeginEditing:"),function(_9,_a,_b){
with(_9){
objj_msgSend(objj_msgSend(DocumentViewEditorView,"sharedInstance"),"setDocumentViewCell:",objj_msgSend(_mainView,"superview"));
}
}),new objj_method(sel_getUid("controlTextDidChange:"),function(_c,_d,_e){
with(_c){
objj_msgSend(_c,"checkForChangedText:",objj_msgSend(objj_msgSend(_e,"object"),"stringValue"));
}
}),new objj_method(sel_getUid("controlTextDidEndEditing:"),function(_f,_10,_11){
with(_f){
objj_msgSend(_f,"checkForChangedText:",objj_msgSend(objj_msgSend(_11,"object"),"stringValue"));
}
}),new objj_method(sel_getUid("controlTextDidFocus:"),function(_12,_13,_14){
with(_12){
...
with(_15){
objj_msgSend(_15,"checkForChangedText:",objj_msgSend(objj_msgSend(_17,"object"),"stringValue"));
}
})]);
p;37;app/mixins/seek_to_dropdown_helpers.jt;2070;@STATIC;1.0;t;2051;
var _1=objj_allocateClassPair(MixinHelper,"SeekToDropdownHelpers"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;34;app/mixins/you_tube_page_element.jt;3365;@STATIC;1.0;t;3346;
var _1=objj_allocateClassPair(MixinHelper,"YouTubePageElement"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_thumbnailUrl"),new objj_ivar("m_imageUrl"),new objj_ivar("m_title"),new objj_ivar("m_owner"),new objj_ivar("m_video"),new objj_ivar("m_search_engines"),new objj_ivar("m_artist_name"),new objj_ivar("m_artist_url"),new objj_ivar("m_rotation"),new objj_ivar("m_seek_to")]);
objj_registerClassPair(_1);
...
}),new objj_method(sel_getUid("rotation"),function(_1c,_1d){
with(_1c){
return m_rotation;
}
}),new objj_method(sel_getUid("seekTo"),function(_1e,_1f){
with(_1e){
return m_seek_to;
}
}),new objj_method(sel_getUid("setSeekTo:"),function(_20,_21,_22){
with(_20){
m_seek_to=_22;
}
}),new objj_method(sel_getUid("updateFromJson"),function(_23,_24){
with(_23){
if(_json.thumbnail){
...
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",PageElementWantsToBeDeletedNotification,_23);
}
if(_json.artist){
...
objj_msgSend(_23,"setSearchEngines:",objj_msgSend(check_for_undefined(_json.m_search_engines,"0"),"intValue"));
m_title=_json.title;
m_owner=_json.uploader;
m_rotation=objj_msgSend(check_for_undefined(_json.rotation,"0"),"intValue");
m_seek_to=objj_msgSend(check_for_undefined(_json.m_seek_to,"0"),"intValue");
}
}),new objj_method(sel_getUid("removeSearchEngine:"),function(_25,_26,_27){
with(_25){
m_search_engines-=(m_search_engines&_27);
}
}),new objj_method(sel_getUid("addSearchEngine:"),function(_28,_29,_2a){
with(_28){
m_search_engines=(m_search_engines|_2a);
}
}),new objj_method(sel_getUid("setRotation:"),function(_2b,_2c,_2d){
with(_2b){
m_rotation=_2d;
if(objj_msgSend(_mainView,"respondsToSelector:",sel_getUid("setRotationDegrees:"))){
objj_msgSend(_mainView,"setRotationDegrees:",m_rotation);
...
}),new objj_method(sel_getUid("videoId"),function(_2e,_2f){
with(_2e){
return objj_msgSend(page_element_id,"intValue");
}
})]);
p;38;app/mixins/you_tube_video_properties.jt;487;@STATIC;1.0;t;469;
var _1=objj_allocateClassPair(MixinHelper,"YouTubeVideoProperties"),_2=_1.isa;
objj_registerClassPair(_1);
...
p;21;app/models/facebook.jt;1656;@STATIC;1.0;t;1637;
...
p;19;app/models/flickr.jt;4823;@STATIC;1.0;t;4804;
...
p;25;app/models/google_image.jt;2149;@STATIC;1.0;t;2130;
...
with(_f){
m_imageUrl=_11;
objj_msgSend(ImageLoaderWorker,"workerFor:imageView:rotation:",m_imageUrl,_mainView,objj_msgSend(_f,"rotation"));
}
...
p;26;app/models/highlight_t_e.jt;6235;@STATIC;1.0;t;6216;
var _1=objj_allocateClassPair(ToolElement,"HighlightTE"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_link_url"),new objj_ivar("m_is_clickable"),new objj_ivar("m_show_as_border"),new objj_ivar("m_border_width"),new objj_ivar("m_rotation"),new objj_ivar("m_corner_top_left"),new objj_ivar("m_corner_top_right"),new objj_ivar("m_corner_bottom_left"),new objj_ivar("m_corner_bottom_right")]);
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("linkUrl"),function(_3,_4){
with(_3){
return m_link_url;
...
}),new objj_method(sel_getUid("rotation"),function(_17,_18){
with(_17){
return m_rotation;
}
...
}),new objj_method(sel_getUid("cornerTopLeft"),function(_1c,_1d){
with(_1c){
return m_corner_top_left;
}
}),new objj_method(sel_getUid("setCornerTopLeft:"),function(_1e,_1f,_20){
with(_1e){
m_corner_top_left=_20;
}
}),new objj_method(sel_getUid("cornerTopRight"),function(_21,_22){
with(_21){
return m_corner_top_right;
}
}),new objj_method(sel_getUid("setCornerTopRight:"),function(_23,_24,_25){
with(_23){
m_corner_top_right=_25;
}
}),new objj_method(sel_getUid("cornerBottomLeft"),function(_26,_27){
with(_26){
return m_corner_bottom_left;
}
}),new objj_method(sel_getUid("setCornerBottomLeft:"),function(_28,_29,_2a){
with(_28){
m_corner_bottom_left=_2a;
}
}),new objj_method(sel_getUid("cornerBottomRight"),function(_2b,_2c){
with(_2b){
return m_corner_bottom_right;
}
}),new objj_method(sel_getUid("setCornerBottomRight:"),function(_2d,_2e,_2f){
with(_2d){
m_corner_bottom_right=_2f;
}
}),new objj_method(sel_getUid("initWithJSONObject:"),function(_30,_31,_32){
with(_30){
_30=objj_msgSendSuper({receiver:_30,super_class:objj_getClass("HighlightTE").super_class},"initWithJSONObject:",_32);
if(_30){
objj_msgSend(PageElementColorSupport,"addToClass:",objj_msgSend(_30,"class"));
objj_msgSend(_30,"setColorFromJson");
initialSize=objj_msgSend(_30,"initialSizeFromJsonOrDefault:",CGSizeMake(150,35));
...
m_color=objj_msgSend(_30,"createColor");
}
return _30;
}
}),new objj_method(sel_getUid("generateViewForDocument:"),function(_33,_34,_35){
with(_33){
if(_mainView){
objj_msgSend(_mainView,"removeFromSuperview");
}
_mainView=objj_msgSend(objj_msgSend(PMHighlightView,"alloc"),"initWithFrame:highlightElement:",CGRectMakeCopy(objj_msgSend(_35,"bounds")),_33);
objj_msgSend(_mainView,"setAutoresizingMask:",CPViewWidthSizable|CPViewHeightSizable);
objj_msgSend(_mainView,"setRotationDegrees:",m_rotation);
objj_msgSend(_35,"addSubview:",_mainView);
}
}),new objj_method(sel_getUid("toolBoxImage"),function(_36,_37){
with(_36){
...
}),new objj_method(sel_getUid("hasRoundedCorners"),function(_38,_39){
with(_38){
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("hasProperties"),function(_3a,_3b){
with(_3a){
return YES;
}
}),new objj_method(sel_getUid("openProperyWindow"),function(_3c,_3d){
with(_3c){
objj_msgSend(objj_msgSend(objj_msgSend(PropertyHighlightTEController,"alloc"),"initWithWindowCibName:pageElement:",HighlightTEPropertyWindowCIB,_3c),"showWindow:",_3c);
}
}),new objj_method(sel_getUid("redisplay"),function(_3e,_3f){
with(_3e){
objj_msgSend(_mainView,"redisplay");
}
}),new objj_method(sel_getUid("setRotation:"),function(_40,_41,_42){
with(_40){
m_rotation=_42;
objj_msgSend(_mainView,"setRotationDegrees:",m_rotation);
}
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("stateCreators"),function(_43,_44){
with(_43){
return [sel_getUid("rotation"),sel_getUid("setRotation:"),sel_getUid("cornerTopLeft"),sel_getUid("setCornerTopLeft:"),sel_getUid("cornerTopRight"),sel_getUid("setCornerTopRight:"),sel_getUid("cornerBottomLeft"),sel_getUid("setCornerBottomLeft:"),sel_getUid("cornerBottomRight"),sel_getUid("setCornerBottomRight:"),sel_getUid("getColor"),sel_getUid("setColor:"),sel_getUid("borderWidth"),sel_getUid("setBorderWidth:"),sel_getUid("clickable"),sel_getUid("setClickable:"),sel_getUid("showAsBorder"),sel_getUid("setShowAsBorder:"),sel_getUid("linkUrl"),sel_getUid("setLinkUrl:")];
}
}),new objj_method(sel_getUid("postStateRestore"),function(_45,_46){
with(_45){
objj_msgSend(_mainView,"redisplay");
}
})]);
p;22;app/models/image_t_e.jt;2088;@STATIC;1.0;t;2069;
...
if(_5){
objj_msgSend(ImageElementProperties,"addToClassOfObject:",_5);
objj_msgSend(PageElementInputSupport,"addToClass:",objj_msgSend(_5,"class"));
...
}),new objj_method(sel_getUid("setImageUrl:"),function(_12,_13,_14){
with(_12){
if(m_urlString!=_14){
m_urlString=_14;
objj_msgSend(ImageLoaderWorker,"workerFor:imageView:rotation:",m_urlString,_mainView,objj_msgSend(_12,"rotation"));
}
}
})]);
p;21;app/models/link_t_e.jt;3082;@STATIC;1.0;t;3063;
...
p;25;app/models/page_element.jt;5636;@STATIC;1.0;t;5617;
...
}),new objj_method(sel_getUid("removeFromServer"),function(_21,_22){
with(_21){
objj_msgSend(objj_msgSend(CommunicationManager,"sharedInstance"),"deleteElement:",_21);
}
}),new objj_method(sel_getUid("removeFromSuperview"),function(_23,_24){
with(_23){
objj_msgSend(_mainView,"removeFromSuperview");
}
}),new objj_method(sel_getUid("addToServer"),function(_25,_26){
with(_25){
objj_msgSend(objj_msgSend(CommunicationManager,"sharedInstance"),"addElement:",_25);
}
}),new objj_method(sel_getUid("updateServer"),function(_27,_28){
with(_27){
objj_msgSend(objj_msgSend(CommunicationManager,"sharedInstance"),"updateElement:",_27);
}
}),new objj_method(sel_getUid("sendResizeToServer"),function(_29,_2a){
with(_29){
objj_msgSend(objj_msgSend(CommunicationManager,"sharedInstance"),"resizeElement:",_29);
}
...
}),new objj_method(sel_getUid("hasProperties"),function(_30,_31){
with(_30){
return NO;
}
}),new objj_method(sel_getUid("openProperyWindow"),function(_32,_33){
with(_32){
}
}),new objj_method(sel_getUid("stateCreators"),function(_34,_35){
with(_34){
return [];
}
...
}),new objj_method(sel_getUid("requestCompleted:"),function(_38,_39,_3a){
with(_38){
switch(_3a.action){
case "page_elements_copy":
_3a.copy._json.width=_3a.copy.width;
_3a.copy._json.height=_3a.copy.height;
var _3b=objj_msgSend(PageElement,"createObjectsFromServerJson:",[_3a.copy]);
objj_msgSend(_3b[0],"setInitialSize:",CGSizeMake(width,height));
var _3c=objj_msgSend(objj_msgSend(DocumentViewController,"sharedInstance"),"addObjectsToView:atLocation:",_3b,objj_msgSend(objj_msgSend(DocumentViewController,"sharedInstance"),"currentMidPoint"));
objj_msgSend(_3b[0],"sendResizeToServer");
objj_msgSend(objj_msgSend(DocumentViewEditorView,"sharedInstance"),"setDocumentViewCell:",_3c[0]);
break;
case "page_elements_create":
if(_3a.status=="ok"){
page_element_id=_3a.page_element_id;
objj_msgSend(_38,"havePageElementIdDoAnyUpdate");
}
CPLogConsole(objj_msgSend(_38,"pageElementId"),"create action: "+_3a.status,"[PM DATA SRC]");
break;
case "page_elements_resize":
CPLogConsole(_3a.status,"resize action","[PM DATA SRC]");
break;
case "page_elements_update":
CPLogConsole(_3a.status,"update action","[PM DATA SRC]");
break;
case "page_elements_destroy":
CPLogConsole(_3a.status,"delete action","[PM DATA SRC]");
if(_3a.status=="ok"){
objj_msgSend(objj_msgSend(DocumentViewController,"sharedInstance"),"removeObject:",_38);
}
break;
}
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("generateObjectsFromJson:forClass:"),function(_3d,_3e,_3f,_40){
with(_3d){
var _41=objj_msgSend(objj_msgSend(CPArray,"alloc"),"init"),idx=_3f.length;
while(idx--){
objj_msgSend(_41,"insertObject:atIndex:",objj_msgSend(objj_msgSend(_40,"alloc"),"initWithJSONObject:",_3f[idx]),0);
}
return _41;
}
}),new objj_method(sel_getUid("createObjectsFromServerJson:"),function(_42,_43,_44){
with(_42){
var _45=objj_msgSend(objj_msgSend(CPArray,"alloc"),"init"),idx=_44.length;
while(idx--){
var _46=_44[idx];
var _47=objj_msgSend(objj_msgSend(CPClassFromString(_46._type),"alloc"),"initWithJSONObject:",_46._json);
_47.x=_46.x;
_47.y=_46.y;
_47.width=_46.width;
_47.height=_46.height;
_47.z_index=_46.z_index;
_47.page_element_id=_46.id;
objj_msgSend(_45,"insertObject:atIndex:",_47,0);
}
return _45;
}
})]);
p;31;app/models/pay_pal_button_t_e.jt;3928;@STATIC;1.0;t;3909;
...
p;21;app/models/text_t_e.jt;2055;@STATIC;1.0;t;2036;
...
p;29;app/models/twitter_feed_t_e.jt;4191;@STATIC;1.0;t;4172;
...
case "@":
return objj_msgSend(CPString,"stringWithFormat:","All tweets to %s",m_term_string);
break;
case "#":
return objj_msgSend(CPString,"stringWithFormat:","Searching for %s",m_term_string);
break;
default:
return objj_msgSend(CPString,"stringWithFormat:","All tweets from %s",m_term_string);
}
}
...
objj_msgSend(m_refView,"setAutoresizingMask:",CPViewNotSizable);
objj_msgSend(m_refView,"setFont:",objj_msgSend(CPFont,"systemFontOfSize:",10));
...
objj_msgSend(_mainView,"setAutoresizingMask:",CPViewNotSizable);
...
p;38;app/models/you_tube_seek_to_link_t_e.jt;3223;@STATIC;1.0;t;3204;
...
p;25;app/models/you_tube_t_e.jt;2563;@STATIC;1.0;t;2544;
...
if(_3){
objj_msgSend(YouTubeVideoProperties,"addToClass:",objj_msgSend(_3,"class"));
objj_msgSend(YouTubePageElement,"addToClass:",objj_msgSend(_3,"class"));
objj_msgSend(PageElementInputSupport,"addToClass:",objj_msgSend(_3,"class"));
...
if(m_thumbnailUrl){
objj_msgSend(ImageLoaderWorker,"workerFor:imageView:rotation:",m_thumbnailUrl,_mainView,objj_msgSend(_a,"rotation"));
}else{
objj_msgSend(_mainView,"setImage:",objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"spinner"));
}
if(!m_origUrl){
...
objj_msgSend(ImageLoaderWorker,"workerFor:imageView:rotation:",m_thumbnailUrl,_mainView,objj_msgSend(_f,"rotation"));
}
...
p;27;app/models/you_tube_video.jt;2544;@STATIC;1.0;t;2525;
var _1=20;
...
if(_6){
objj_msgSend(YouTubeVideoProperties,"addToClass:",objj_msgSend(_6,"class"));
objj_msgSend(YouTubePageElement,"addToClass:",objj_msgSend(_6,"class"));
...
objj_msgSend(_mainView,"setImageScaling:",CPScaleToFit);
objj_msgSend(_mainView,"setHasShadow:",NO);
objj_msgSend(ImageLoaderWorker,"workerFor:imageView:rotation:",objj_msgSend(_b,"largeImageUrl"),_mainView,objj_msgSend(_b,"rotation"));
...
p;32;app/views/document_resize_view.jt;1098;@STATIC;1.0;t;1079;
var _1=objj_allocateClassPair(CPView,"DocumentResizeView"),_2=_1.isa;
objj_registerClassPair(_1);
class_addMethods(_1,[new objj_method(sel_getUid("initWithFrame:"),function(_3,_4,_5){
with(_3){
_3=objj_msgSendSuper({receiver:_3,super_class:objj_getClass("DocumentResizeView").super_class},"initWithFrame:",_5);
var _6=objj_msgSend(objj_msgSend(CPSlider,"alloc"),"initWithFrame:",CGRectMake(30,CGRectGetHeight(_5)/2-8,CGRectGetWidth(_5)-65,24));
objj_msgSend(_6,"setMinValue:",50);
objj_msgSend(_6,"setMaxValue:",250);
objj_msgSend(_6,"setIntValue:",150);
objj_msgSend(_6,"setAction:",sel_getUid("adjustPublicationZoom:"));
objj_msgSend(_3,"addSubview:",_6);
var _7=objj_msgSend(CPTextField,"flickr_labelWithText:","50");
objj_msgSend(_7,"setFrameOrigin:",CGPointMake(0,CGRectGetHeight(_5)/2-4));
objj_msgSend(_3,"addSubview:",_7);
_7=objj_msgSend(CPTextField,"flickr_labelWithText:","250");
objj_msgSend(_7,"setFrameOrigin:",CGPointMake(CGRectGetWidth(_5)-CGRectGetWidth(objj_msgSend(_7,"frame")),CGRectGetHeight(_5)/2-4));
objj_msgSend(_3,"addSubview:",_7);
return _3;
}
})]);
p;25;app/views/document_view.jt;6553;@STATIC;1.0;t;6534;
...
class_addIvars(_4,[new objj_ivar("_itemData"),new objj_ivar("_itemPrototype"),new objj_ivar("_controller")]);
objj_registerClassPair(_4);
...
_itemPrototype=objj_msgSend(objj_msgSend(CPCollectionViewItem,"alloc"),"init");
objj_msgSend(DocumentViewCellWithoutSnapgrid,"addToClass:",DocumentViewCell);
objj_msgSend(_itemPrototype,"setView:",objj_msgSend(objj_msgSend(DocumentViewCell,"alloc"),"initWithFrame:",CGRectMake(0,0,150,150)));
...
var _f=objj_msgSend(CPKeyedUnarchiver,"unarchiveObjectWithData:",_itemData);
objj_msgSend(_f,"setRepresentedObject:",_e);
return _f;
}
}),new objj_method(sel_getUid("setContent:"),function(_10,_11,_12){
with(_10){
var _13=objj_msgSend(_10,"subviews");
for(var idx=0;idx<_13.length;idx++){
objj_msgSend(_13[idx],"removeFromSuperview");
}
if(!_12){
return;
}
objj_msgSend(_12,"sortUsingSelector:",sel_getUid("compareZ:"));
var idx=objj_msgSend(_12,"count");
while(idx--){
var _14=objj_msgSend(_10,"newItemForRepresentedObject:",_12[idx]);
var _15=objj_msgSend(_14,"view");
objj_msgSend(_15,"setFrame:",objj_msgSend(_12[idx],"location"));
objj_msgSend(_10,"addSubview:",_15);
}
}
}),new objj_method(sel_getUid("addObjectsToView:atLocation:"),function(_16,_17,_18,_19){
with(_16){
var _1a=objj_msgSend(_16,"convertPoint:fromView:",_19,nil);
var _1b=objj_msgSend(CPArray,"array");
for(var idx=0;idx<objj_msgSend(_18,"count");idx++){
var _1c=objj_msgSend(_16,"newItemForRepresentedObject:",_18[idx]);
var _1d=objj_msgSend(_1c,"view");
var _1e=CGPointMake(_1a.x-CGRectGetWidth(objj_msgSend(_1d,"frame"))/2,_1a.y-CGRectGetHeight(objj_msgSend(_1d,"frame"))/2);
objj_msgSend(_1d,"setFrameOrigin:",_1e);
objj_msgSend(_1d,"setFrameSize:",objj_msgSend(_18[idx],"initialSize"));
objj_msgSend(_18[idx],"setLocation:",objj_msgSend(_1d,"frame"));
objj_msgSend(_18[idx],"setZIndex:",objj_msgSend(objj_msgSend(DocumentViewController,"sharedInstance"),"nextZIndex"));
objj_msgSend(_16,"addSubview:",_1d);
_1b.push(_1d);
}
return _1b;
}
}),new objj_method(sel_getUid("performDragOperation:"),function(_1f,_20,_21){
with(_1f){
CPLogConsole("peforming drag operations @ collection view");
var _22=objj_msgSend(_1f,"obtainModelObjects:",_21);
objj_msgSend(objj_msgSend(DocumentViewEditorView,"sharedInstance"),"setDocumentViewCell:",nil);
for(var idx=0;idx<_22.length;idx++){
_22[idx]=objj_msgSend(_22[idx],"cloneForDrop");
}
objj_msgSend(_controller,"draggedObjects:atLocation:",_22,objj_msgSend(_21,"draggingLocation"));
objj_msgSend(_1f,"setHighlight:",NO);
}
}),new objj_method(sel_getUid("draggingEntered:"),function(_23,_24,_25){
with(_23){
objj_msgSend(_23,"setHighlight:",YES);
}
}),new objj_method(sel_getUid("draggingExited:"),function(_26,_27,_28){
with(_26){
objj_msgSend(_26,"setHighlight:",NO);
}
}),new objj_method(sel_getUid("setHighlight:"),function(_29,_2a,_2b){
with(_29){
if(_2b){
objj_msgSend(_29,"setBackgroundColor:",_3);
}else{
objj_msgSend(_29,"setBackgroundColor:",objj_msgSend(objj_msgSend(objj_msgSend(PageViewController,"sharedInstance"),"currentPageObj"),"getColor"));
}
}
}),new objj_method(sel_getUid("obtainModelObjects:"),function(_2c,_2d,_2e){
with(_2c){
var _2f=nil,_30=nil;
for(var idx=0;idx<objj_msgSend(_2,"count");idx++){
_30=_2[idx];
_2f=objj_msgSend(objj_msgSend(_2e,"draggingPasteboard"),"dataForType:",_30);
if(_2f){
return objj_msgSend(_2c,"performSelector:withObject:",objj_msgSend(_1,"objectForKey:",_30),_2f);
}
}
return [];
}
}),new objj_method(sel_getUid("dropHandleFlickr:"),function(_31,_32,_33){
with(_31){
return objj_msgSend(DocumentView,"_retrieveObjectsWithSelector:usingData:",sel_getUid("flickrImageForId:"),_33);
}
}),new objj_method(sel_getUid("dropHandleTweets:"),function(_34,_35,_36){
with(_34){
return objj_msgSend(DocumentView,"_retrieveObjectsWithSelector:usingData:",sel_getUid("tweetForId:"),_36);
}
}),new objj_method(sel_getUid("dropHandleFacebook:"),function(_37,_38,_39){
with(_37){
return objj_msgSend(DocumentView,"_retrieveObjectsWithSelector:usingData:",sel_getUid("facebookItemForId:"),_39);
}
}),new objj_method(sel_getUid("dropHandleToolElement:"),function(_3a,_3b,_3c){
with(_3a){
return objj_msgSend(DocumentView,"_retrieveObjectsWithSelector:usingData:",sel_getUid("toolElementForId:"),_3c);
}
}),new objj_method(sel_getUid("dropHandleGoogleImages:"),function(_3d,_3e,_3f){
with(_3d){
return objj_msgSend(DocumentView,"_retrieveObjectsWithSelector:usingData:",sel_getUid("googleImageForId:"),_3f);
}
}),new objj_method(sel_getUid("dropHandleYouTubeVideos:"),function(_40,_41,_42){
with(_40){
return objj_msgSend(DocumentView,"_retrieveObjectsWithSelector:usingData:",sel_getUid("youTubeVideoForId:"),_42);
}
})]);
class_addMethods(_5,[new objj_method(sel_getUid("_retrieveObjectsWithSelector:usingData:"),function(_43,_44,_45,_46){
with(_43){
_46=objj_msgSend(CPKeyedUnarchiver,"unarchiveObjectWithData:",_46);
var _47=[];
for(var idx=0;idx<objj_msgSend(_46,"count");idx++){
var obj=objj_msgSend(objj_msgSend(DragDropManager,"sharedInstance"),"performSelector:withObject:",_45,_46[idx]);
if(obj){
objj_msgSend(_47,"addObject:",obj);
}
}
return _47;
}
})]);
p;30;app/views/document_view_cell.jt;3398;@STATIC;1.0;t;3379;
var _1=objj_allocateClassPair(CPView,"DocumentViewCell"),_2=_1.isa;
...
objj_msgSend(_5,"removeNotificationListener");
}
representedObject=_7;
objj_msgSend(representedObject,"generateViewForDocument:",_5);
objj_msgSend(_5,"setupNotificationListener");
objj_msgSend(_5,"setClipsToBounds:",NO);
}
}),new objj_method(sel_getUid("setSelected:"),function(_8,_9,_a){
with(_8){
objj_msgSend(objj_msgSend(DocumentViewEditorView,"sharedInstance"),"setDocumentViewCell:",_8);
}
}),new objj_method(sel_getUid("setupNotificationListener"),function(_b,_c){
with(_b){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",_b,sel_getUid("pageElementSuicide:"),PageElementWantsToBeDeletedNotification,representedObject);
}
}),new objj_method(sel_getUid("removeNotificationListener"),function(_d,_e){
with(_d){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",_d,PageElementWantsToBeDeletedNotification,representedObject);
}
}),new objj_method(sel_getUid("pageElementSuicide:"),function(_f,_10,_11){
with(_f){
objj_msgSend(_f,"deleteFromPage");
}
}),new objj_method(sel_getUid("deleteFromPage"),function(_12,_13){
with(_12){
if(representedObject){
objj_msgSend(representedObject,"removeFromSuperview");
...
objj_msgSend(_12,"removeFromSuperview");
}
}),new objj_method(sel_getUid("cloneAndAddToPage"),function(_14,_15){
with(_14){
if(representedObject){
objj_msgSend(objj_msgSend(CommunicationManager,"sharedInstance"),"copyElement:",representedObject);
}
}
}),new objj_method(sel_getUid("willBeginLiveResize"),function(_16,_17){
with(_16){
}
}),new objj_method(sel_getUid("didEndLiveResize"),function(_18,_19){
with(_18){
objj_msgSend(_18,"sendResizeToServer");
}
}),new objj_method(sel_getUid("doResize:"),function(_1a,_1b,_1c){
with(_1a){
objj_msgSend(_1a,"setFrameSize:",_1c.size);
objj_msgSend(_1a,"setFrameOrigin:",_1c.origin);
objj_msgSend(_1a,"setNeedsDisplay:",YES);
}
}),new objj_method(sel_getUid("mouseDown:"),function(_1d,_1e,_1f){
with(_1d){
objj_msgSend(_1d,"setSelected:",YES);
objj_msgSend(objj_msgSend(CPCursor,"closedHandCursor"),"set");
editedOrigin=objj_msgSend(_1d,"frame").origin;
dragLocation=objj_msgSend(_1f,"locationInWindow");
}
}),new objj_method(sel_getUid("mouseUp:"),function(_20,_21,_22){
with(_20){
objj_msgSend(objj_msgSend(CPCursor,"arrowCursor"),"set");
objj_msgSend(_20,"setSelected:",NO);
objj_msgSend(_20,"setFrameOrigin:",objj_msgSend(_20,"frame").origin);
objj_msgSend(_20,"sendResizeToServer");
}
}),new objj_method(sel_getUid("setZIndex:"),function(_23,_24,_25){
with(_23){
objj_msgSend(representedObject,"setZIndex:",_25);
objj_msgSend(_23,"sendResizeToServer");
}
}),new objj_method(sel_getUid("sendResizeToServer"),function(_26,_27){
with(_26){
objj_msgSend(objj_msgSend(representedObject,"setLocation:",objj_msgSend(_26,"frame")),"sendResizeToServer");
}
})]);
p;37;app/views/document_view_editor_view.jt;12387;@STATIC;1.0;t;12367;
var _1=nil;
var _2=26;
var _3=16;
var _4=nil;
...
var _6=objj_allocateClassPair(CPView,"DocumentViewEditorView"),_7=_6.isa;
class_addIvars(_6,[new objj_ivar("m_documentViewCell"),new objj_ivar("m_handleIdx"),new objj_ivar("m_isResizing"),new objj_ivar("m_isMoving"),new objj_ivar("m_handlesRects"),new objj_ivar("m_handlesViews")]);
...
m_isResizing=NO;
m_isMoving=NO;
objj_msgSend(_a,"setClipsToBounds:",NO);
}
return _a;
}
}),new objj_method(sel_getUid("keyDown:"),function(_d,_e,_f){
with(_d){
}
}),new objj_method(sel_getUid("acceptsFirstResponder"),function(_10,_11){
with(_10){
return YES;
}
}),new objj_method(sel_getUid("setDocumentViewCell:"),function(_12,_13,_14){
with(_12){
if(m_documentViewCell==_14){
return;
}
objj_msgSend(_12,"hideToolTip");
if(m_documentViewCell){
objj_msgSend(_12,"removeAllObservers");
}
m_documentViewCell=_14;
if(m_documentViewCell){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",_12,sel_getUid("documentViewCellFrameChanged:"),CPViewFrameDidChangeNotification,m_documentViewCell);
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",_12,sel_getUid("pageElementDidResize:"),PageElementDidResizeNotification,objj_msgSend(m_documentViewCell,"pageElement"));
var _15=objj_msgSend(_14,"frame").origin,_16=objj_msgSend(_14,"bounds").size;
objj_msgSend(_12,"setFrame:",CGRectMake(_15.x-_2,_15.y-_2,_16.width+(_2*2),_16.height+(_2*2)));
objj_msgSend(m_documentViewCell,"setZIndex:",objj_msgSend(objj_msgSend(DocumentViewController,"sharedInstance"),"nextZIndex"));
objj_msgSend(objj_msgSend(m_documentViewCell,"superview"),"addSubview:",_12);
objj_msgSend(objj_msgSend(m_documentViewCell,"superview"),"addSubview:",m_documentViewCell);
}else{
objj_msgSend(_12,"removeFromSuperview");
}
}
}),new objj_method(sel_getUid("removeAllObservers"),function(_17,_18){
with(_17){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",_17,PageElementDidResizeNotification,objj_msgSend(m_documentViewCell,"pageElement"));
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",_17,CPViewFrameDidChangeNotification,m_documentViewCell);
}
}),new objj_method(sel_getUid("pageElementDidResize:"),function(_19,_1a,_1b){
with(_19){
var _1c=objj_msgSend(objj_msgSend(m_documentViewCell,"pageElement"),"getSize");
objj_msgSend(m_documentViewCell,"setFrameSize:",_1c);
objj_msgSend(_19,"setFrameSize:",CGSizeMake(_1c.width+(_2*2),_1c.height+(_2*2)));
}
}),new objj_method(sel_getUid("documentViewCellFrameChanged:"),function(_1d,_1e,_1f){
with(_1d){
var _20=objj_msgSend(m_documentViewCell,"frame"),_21=CGRectGetWidth(objj_msgSend(_1d,"frame"));
objj_msgSend(_1d,"setFrameOrigin:",CGPointMake(CGRectGetMidX(_20)-_21/2,CGRectGetMidY(_20)-_21/2));
}
}),new objj_method(sel_getUid("rightMouseDown:"),function(_22,_23,_24){
with(_22){
m_isMoving=YES;
objj_msgSend(objj_msgSend(CPCursor,"closedHandCursor"),"set");
objj_msgSend(m_documentViewCell,"mouseDown:",_24);
}
}),new objj_method(sel_getUid("rightMouseDownOnView:withEvent:"),function(_25,_26,_27,_28){
with(_25){
objj_msgSend(_25,"setDocumentViewCell:",_27);
}
}),new objj_method(sel_getUid("mouseDown:"),function(_29,_2a,_2b){
with(_29){
if(objj_msgSend(_2b,"clickCount")==2&&objj_msgSend(objj_msgSend(m_documentViewCell,"pageElement"),"hasProperties")){
objj_msgSend(objj_msgSend(m_documentViewCell,"pageElement"),"openProperyWindow");
return;
}
var _2c=objj_msgSend(_29,"convertPoint:fromView:",objj_msgSend(_2b,"locationInWindow"),nil);
m_handleIdx=objj_msgSend(_29,"getHandleIndex:",_2c);
objj_msgSend(_29,"hideToolTip");
switch(m_handleIdx){
case 0:
objj_msgSend(_29,"deletePageElement");
break;
case 1:
objj_msgSend(objj_msgSend(m_documentViewCell,"pageElement"),"openProperyWindow");
break;
case 2:
objj_msgSend(m_documentViewCell,"cloneAndAddToPage");
break;
case 3:
case 4:
case 5:
...
m_isMoving=YES;
objj_msgSend(objj_msgSend(CPCursor,"closedHandCursor"),"set");
objj_msgSend(m_documentViewCell,"mouseDown:",_2b);
break;
case 7:
objj_msgSendSuper({receiver:_29,super_class:objj_getClass("DocumentViewEditorView").super_class},"mouseDown:",_2b);
break;
}
}
}),new objj_method(sel_getUid("mouseDragged:"),function(_2d,_2e,_2f){
with(_2d){
objj_msgSend(_2d,"hideToolTip");
if(!m_isResizing&&!m_isMoving){
return;
}
if(m_isMoving){
objj_msgSend(m_documentViewCell,"mouseDragged:",_2f);
}
if(m_isResizing){
objj_msgSend(objj_msgSend(CPCursor,"closedHandCursor"),"set");
var _30=objj_msgSend(_2d,"convertPoint:fromView:",objj_msgSend(_2f,"locationInWindow"),nil);
var _31=objj_msgSend(_2d,"makeNewSize:",_30);
objj_msgSend(m_documentViewCell,"doResize:",CGRectInset(_31,_2,_2));
objj_msgSend(_2d,"setFrameSize:",_31.size);
objj_msgSend(_2d,"setFrameOrigin:",_31.origin);
objj_msgSend(_2d,"setNeedsDisplay:",YES);
}
}
}),new objj_method(sel_getUid("mouseUp:"),function(_32,_33,_34){
with(_32){
if(!m_isResizing&&!m_isMoving){
return;
}
if(m_isMoving){
objj_msgSend(m_documentViewCell,"mouseUp:",_34);
}
if(m_isResizing){
...
}),new objj_method(sel_getUid("hideToolTip"),function(_35,_36){
with(_35){
if(_4){
...
}),new objj_method(sel_getUid("deletePageElement"),function(_37,_38){
with(_37){
objj_msgSend(m_documentViewCell,"deleteFromPage");
objj_msgSend(_37,"removeAllObservers");
m_documentViewCell=nil;
objj_msgSend(_37,"removeFromSuperview");
}
}),new objj_method(sel_getUid("makeNewSize:"),function(_39,_3a,_3b){
with(_39){
var _3c=objj_msgSend(_39,"frame");
var _3d=_3c.origin.x,_3e=_3c.origin.y,_3f=_3c.size.width,_40=_3c.size.height;
var _41=nil;
switch(m_handleIdx){
case 3:
...
return CGRectMake(_3d,_3e,MAX(_3f,55),MAX(_40,55));
}
}),new objj_method(sel_getUid("newButtonAtIndex:image:rect:"),function(_42,_43,idx,_44,_45){
with(_42){
if(m_handlesViews[idx]){
objj_msgSend(m_handlesViews[idx],"removeFromSuperview");
}
m_handlesViews[idx]=objj_msgSend(DVEVButton,"buttonWithImage:withFrame:andToolTip:",_44,_45,_5[idx]);
objj_msgSend(_42,"addSubview:",m_handlesViews[idx]);
}
}),new objj_method(sel_getUid("getHandleIndex:"),function(_46,_47,_48){
with(_46){
for(var idx=0;idx<m_handlesRects.length;idx++){
if(CGRectContainsPoint(m_handlesRects[idx],_48)){
return idx;
}
}
return -1;
}
}),new objj_method(sel_getUid("drawRect:"),function(_49,_4a,_4b){
with(_49){
var _4c=CGRectInset(objj_msgSend(_49,"bounds"),10,10),_4d=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort"),_4e=CGRectGetWidth(_4c)/2;
CGContextSetStrokeColor(_4d,objj_msgSend(ThemeManager,"editorBgColor"));
CGContextSetLineWidth(_4d,1);
CGContextStrokeRect(_4d,_4c);
CGContextSetAlpha(_4d,1);
objj_msgSend(_49,"drawAndStoreHandles:withContext:",_4c,_4d);
}
}),new objj_method(sel_getUid("drawAndStoreHandles:withContext:"),function(_4f,_50,_51,_52){
with(_4f){
m_handlesRects=[];
...
switch(idx){
case 0:
_53=CGRectMake(-1.5,-1.5,_3*1.3,_3*1.3);
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",0,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"deleteButton"),_53);
break;
case 1:
_53=CGRectMake(CGRectGetMidX(_51)-(_3/2)-3.5,-2.5,_3*1.5,_3*1.5);
if(objj_msgSend(objj_msgSend(m_documentViewCell,"pageElement"),"hasProperties")){
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",1,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"propertyButton"),_53);
}else{
if(m_handlesViews[1]){
objj_msgSend(m_handlesViews[1],"removeFromSuperview");
}
}
break;
case 2:
_53=CGRectMake(CGRectGetMaxX(_51)-(_3/2)-1,-1,_3*1.3,_3*1.3);
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",2,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"copyButton"),_53);
break;
case 3:
_53=CGRectMake(CGRectGetMaxX(_51)-(_3/2)+2,CGRectGetMidY(_51)-(_3/2),_3*1.3,_3*1.3);
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",3,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"resizeRightButton"),_53);
break;
case 4:
_53=CGRectMake(CGRectGetMaxX(_51)-(_3/2)-8,CGRectGetMaxY(_51)-(_3/2)-8,_3*1.3,_3*1.3);
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",4,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"resizeDiagonalButton"),_53);
break;
case 5:
_53=CGRectMake(CGRectGetMidX(_51)-_3/2,CGRectGetMaxY(_51)-_3/2+2,_3*1.3,_3*1.3);
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",5,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"resizeBottomButton"),_53);
break;
case 6:
_53=CGRectMake(0,CGRectGetMaxY(_51)-(_3/2),_3*1.3,_3*1.3);
objj_msgSend(_4f,"newButtonAtIndex:image:rect:",6,objj_msgSend(objj_msgSend(PlaceholderManager,"sharedInstance"),"moveButton"),_53);
break;
case 7:
_53=CGRectMake(0,CGRectGetMidY(_51)-_3/2,_3*1.3,_3*1.3);
break;
}
m_handlesRects.push(_53);
}
}
})]);
class_addMethods(_7,[new objj_method(sel_getUid("sharedInstance"),function(_54,_55){
with(_54){
if(!_1){
...
var _6=objj_allocateClassPair(CPImageView,"DVEVButton"),_7=_6.isa;
class_addIvars(_6,[new objj_ivar("m_toolTip"),new objj_ivar("m_toolTipTimer"),new objj_ivar("m_showToolTip")]);
objj_registerClassPair(_6);
class_addMethods(_6,[new objj_method(sel_getUid("toolTip"),function(_56,_57){
with(_56){
return m_toolTip;
}
}),new objj_method(sel_getUid("setToolTip:"),function(_58,_59,_5a){
with(_58){
m_toolTip=_5a;
}
}),new objj_method(sel_getUid("initWithFrame:"),function(_5b,_5c,_5d){
with(_5b){
_5b=objj_msgSendSuper({receiver:_5b,super_class:objj_getClass("DVEVButton").super_class},"initWithFrame:",_5d);
if(_5b){
objj_msgSend(_5b,"setAutoresizingMask:",CPViewNotSizable);
objj_msgSend(_5b,"setHasShadow:",NO);
objj_msgSend(objj_msgSend(_5b,"window"),"setAcceptsMouseMovedEvents:",YES);
m_showToolTip=objj_msgSend(objj_msgSend(CPInvocation,"alloc"),"initWithMethodSignature:",nil);
objj_msgSend(m_showToolTip,"setTarget:",_5b);
objj_msgSend(m_showToolTip,"setSelector:",sel_getUid("showToolTip"));
m_toolTipTimer=nil;
}
return _5b;
}
}),new objj_method(sel_getUid("showToolTip"),function(_5e,_5f){
with(_5e){
if(_4){
objj_msgSend(_4,"close");
_4=nil;
...
if(m_toolTip){
_4=objj_msgSend(TNToolTip,"toolTipWithString:forView:closeAfter:",m_toolTip,_5e,2.5);
}
}
}),new objj_method(sel_getUid("mouseEntered:"),function(_60,_61,_62){
with(_60){
if(!m_toolTipTimer){
m_toolTipTimer=objj_msgSend(CPTimer,"scheduledTimerWithTimeInterval:invocation:repeats:",2,m_showToolTip,NO);
}
}
}),new objj_method(sel_getUid("mouseExited:"),function(_63,_64,_65){
with(_63){
if(m_toolTipTimer){
objj_msgSend(m_toolTipTimer,"invalidate");
}
m_toolTipTimer=nil;
}
}),new objj_method(sel_getUid("removeFromSuperview"),function(_66,_67){
with(_66){
objj_msgSendSuper({receiver:_66,super_class:objj_getClass("DVEVButton").super_class},"removeFromSuperview");
if(m_toolTipTimer){
objj_msgSend(m_toolTipTimer,"invalidate");
}
m_toolTipTimer=nil;
...
class_addMethods(_7,[new objj_method(sel_getUid("buttonWithImage:withFrame:andToolTip:"),function(_68,_69,_6a,_6b,_6c){
with(_68){
var _6d=objj_msgSend(objj_msgSend(DVEVButton,"alloc"),"initWithFrame:",_6b);
objj_msgSend(_6d,"setImage:",_6a);
objj_msgSend(_6d,"setToolTip:",_6c);
return _6d;
}
})]);
...
p;37;app/views/models/p_m_highlight_view.jt;3823;@STATIC;1.0;t;3804;
var _1=objj_allocateClassPair(CPView,"PMHighlightView"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_rootLayer"),new objj_ivar("m_highlightElement")]);
objj_registerClassPair(_1);
...
objj_msgSend(m_rootLayer,"setDelegate:",_3);
objj_msgSend(_3,"setClipsToBounds:",NO);
objj_msgSend(_3,"setWantsLayer:",YES);
objj_msgSend(_3,"setLayer:",m_rootLayer);
}
return _3;
}
...
with(_9){
objj_msgSend(_9,"setRotationRadians:",(_b*(Math.PI/180)));
}
}),new objj_method(sel_getUid("setRotationRadians:"),function(_c,_d,_e){
with(_c){
if(m_rotationRadians===_e){
return;
}
m_rotationRadians=_e;
objj_msgSend(m_rootLayer,"setAffineTransform:",CGAffineTransformMakeRotation(m_rotationRadians));
}
}),new objj_method(sel_getUid("drawLayer:inContext:"),function(_f,_10,_11,_12){
with(_f){
var _13=objj_msgSend(_11,"bounds");
CGContextSetFillColor(_12,objj_msgSend(m_highlightElement,"getColor"));
CGContextSetStrokeColor(_12,objj_msgSend(m_highlightElement,"getColor"));
if(objj_msgSend(m_highlightElement,"showAsBorder")==0){
var _14=objj_msgSend(_f,"roundedRectangleInRect:",_13);
CGContextBeginPath(_12);
CGContextAddPath(_12,_14);
CGContextClosePath(_12);
CGContextFillPath(_12);
}else{
_13=CGRectInset(_13,objj_msgSend(m_highlightElement,"borderWidth")/2,objj_msgSend(m_highlightElement,"borderWidth")/2);
var _14=objj_msgSend(_f,"roundedRectangleInRect:",_13);
CGContextBeginPath(_12);
CGContextAddPath(_12,_14);
CGContextClosePath(_12);
CGContextSetLineWidth(_12,objj_msgSend(m_highlightElement,"borderWidth"));
CGContextStrokePath(_12);
}
}
}),new objj_method(sel_getUid("roundedRectangleInRect:"),function(_15,_16,_17){
with(_15){
var _18=CGPathCreateMutable(),_19=CGRectGetMinX(_17),_1a=CGRectGetMaxX(_17),_1b=CGRectGetMinY(_17),_1c=CGRectGetMaxY(_17);
CGPathMoveToPoint(_18,nil,_19+objj_msgSend(m_highlightElement,"cornerTopLeft"),_1b);
if(objj_msgSend(m_highlightElement,"cornerTopRight")>0){
CGPathAddLineToPoint(_18,nil,_1a-objj_msgSend(m_highlightElement,"cornerTopRight"),_1b);
CGPathAddCurveToPoint(_18,nil,_1a-objj_msgSend(m_highlightElement,"cornerTopRight"),_1b,_1a,_1b,_1a,_1b+objj_msgSend(m_highlightElement,"cornerTopRight"));
}else{
CGPathAddLineToPoint(_18,nil,_1a,_1b);
}
if(objj_msgSend(m_highlightElement,"cornerBottomRight")>0){
CGPathAddLineToPoint(_18,nil,_1a,_1c-objj_msgSend(m_highlightElement,"cornerBottomRight"));
CGPathAddCurveToPoint(_18,nil,_1a,_1c-objj_msgSend(m_highlightElement,"cornerBottomRight"),_1a,_1c,_1a-objj_msgSend(m_highlightElement,"cornerBottomRight"),_1c);
}else{
CGPathAddLineToPoint(_18,nil,_1a,_1c);
}
if(objj_msgSend(m_highlightElement,"cornerBottomLeft")>0){
CGPathAddLineToPoint(_18,nil,_19+objj_msgSend(m_highlightElement,"cornerBottomLeft"),_1c);
CGPathAddCurveToPoint(_18,nil,_19+objj_msgSend(m_highlightElement,"cornerBottomLeft"),_1c,_19,_1c,_19,_1c-objj_msgSend(m_highlightElement,"cornerBottomLeft"));
}else{
CGPathAddLineToPoint(_18,nil,_19,_1c);
}
if(objj_msgSend(m_highlightElement,"cornerTopLeft")>0){
CGPathAddLineToPoint(_18,nil,_19,_1b+objj_msgSend(m_highlightElement,"cornerTopLeft"));
CGPathAddCurveToPoint(_18,nil,_19,_1b+objj_msgSend(m_highlightElement,"cornerTopLeft"),_19,_1b,_19+objj_msgSend(m_highlightElement,"cornerTopLeft"),_1b);
}else{
CGPathAddLineToPoint(_18,nil,_19,_1b);
}
CGPathCloseSubpath(_18);
return _18;
}
})]);
p;33;app/views/models/p_m_image_view.jt;2139;@STATIC;1.0;t;2120;
var _1=objj_allocateClassPair(CPImageView,"PMImageView"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("m_imageLayer"),new objj_ivar("m_image"),new objj_ivar("m_rotationRadians"),new objj_ivar("m_scale_x"),new objj_ivar("m_scale_y")]);
objj_registerClassPair(_1);
...
m_scale_y=1;
m_image=nil;
m_imageLayer=objj_msgSend(CALayer,"layer");
objj_msgSend(m_imageLayer,"setDelegate:",_5);
objj_msgSend(_5,"setClipsToBounds:",NO);
objj_msgSend(_5,"setWantsLayer:",YES);
objj_msgSend(_5,"setLayer:",m_imageLayer);
}
return _5;
}
}),new objj_method(sel_getUid("setRotationDegrees:"),function(_8,_9,_a){
with(_8){
objj_msgSend(_8,"setRotationRadians:",(_a*(Math.PI/180)));
}
}),new objj_method(sel_getUid("setRotationRadians:"),function(_b,_c,_d){
with(_b){
if(m_rotationRadians==_d){
return;
}
m_rotationRadians=_d;
objj_msgSend(m_imageLayer,"setAffineTransform:",CGAffineTransformScale(CGAffineTransformMakeRotation(m_rotationRadians),m_scale_x,m_scale_y));
}
}),new objj_method(sel_getUid("setScaleWithX:withY:"),function(_e,_f,_10,_11){
with(_e){
if(m_scale_x==_10&&m_scale_y==_11){
return;
}
m_scale_x=_10;
m_scale_y=_11;
...
}),new objj_method(sel_getUid("setImage:"),function(_12,_13,_14){
with(_12){
if(m_image==_14){
return;
}
m_image=_14;
objj_msgSend(_12,"setFrameOrigin:",CGPointMake(0,0));
objj_msgSend(_12,"setFrameSize:",CGSizeMake(objj_msgSend(_12,"frame").size.width,objj_msgSend(_12,"frame").size.height));
objj_msgSend(m_imageLayer,"setNeedsDisplay");
}
}),new objj_method(sel_getUid("drawLayer:inContext:"),function(_15,_16,_17,_18){
with(_15){
var _19=objj_msgSend(_17,"bounds");
if(m_image){
CGContextDrawImage(_18,_19,m_image);
}
}
})]);
p;15;AppController.jt;16557;@STATIC;1.0;I;21;Foundation/CPObject.jI;17;AppKit/CPCookie.jI;15;AppKit/CPView.jI;13;TNKit/TNKit.jI;17;TNKit/TNToolTip.jI;20;TNKit/TNCategories.jI;13;LPKit/LPKit.jI;28;LPKit/LPMultiLineTextField.jI;24;LPKit/LPURLPostRequest.ji;12;app/editor.jt;16307;
